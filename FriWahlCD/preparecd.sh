...
mkarchiso -v -C /tmp/pacman.conf -p "openssh unzip zip irssi ipw2100-fw ipw2200-fw wireless_tools zd1211-firmware broadcom-wl net-tools openssl perl vpnc iptables dhcp dhclient fping curl perl-www-curl expect netcfg pygobject vim wavemon dialog-usta fbsplash fbsplash-theme-usta" create
